...
String LOG_NAME = System.getenv('LOG_NAME') ?: System.getProperty('log.name') ?: 'patent-poc'
...
logger('com.sra.patent', INFO, ['STDOUT','ROLLING_FILE'], false)
...
logger('io.micronaut', ERROR, [/*'STDOUT',*/'ROLLING_FILE'], false)